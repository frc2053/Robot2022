...
static constexpr auto KV = 0.009209_V / 1_rad_per_s;
static constexpr auto KA = 0.0022506_V / 1_rad_per_s_sq;
static constexpr auto KS = 0.63257_V;
static constexpr double SHOOTER_KP = 0.01367;
